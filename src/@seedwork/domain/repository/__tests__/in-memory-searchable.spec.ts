...
describe('InMemorySearchableRepository Unit Tests', () => {
  ...
  describe('applyFilter method', () => {
    it('should no filter items whe filter param is null', async () => {
      const items = [new StubEntity({ name: 'name value', price: 2 })];
  ...
  describe('search method', () => {
    it('should apply only paginate when orther params are null', async () => {
    ...
    it('should apply paginate and sort', async () => {
      ...
      for (const i of arrange) {
        result = await repository.search(i.params);
